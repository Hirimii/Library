local ToggleScript = Instance.new("ScreenGui")
local ImageButton1 = Instance.new("ImageButton")
local UICorner = Instance.new("UICorner")

ToggleScript.Name = "ToggleScript"
ToggleScript.Parent = game.CoreGui
ToggleScript.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

ImageButton1.Parent = ToggleScript
...
if game:GetService("CoreGui"):FindFirstChild("ToggleScript") then
    game:GetService("CoreGui"):FindFirstChild("ToggleScript"):Destroy()
end

if game:GetService("CoreGui"):FindFirstChild("HIRIMILIB") then
    game:GetService("CoreGui"):FindFirstChild("HIRIMILIB"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    local HIRIMILIB = Instance.new("ScreenGui")
    HIRIMILIB.Name = "HIRIMILIB"
    HIRIMILIB.Parent = game.CoreGui
    HIRIMILIB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

    local Main = Instance.new("Frame")
    Main.Name = "Main"
    Main.Parent = HIRIMILIB
    ...
    Frame_2.Position = UDim2.new(0.25, 0, 0.1, 0)
    Frame_2.Size = UDim2.new(0, 3, 0, 313)
    ...
    Frame_23.Parent = Top
    Frame_23.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Frame_23.BorderColor3 = Color3.fromRGB(0, 0, 0)
    Frame_23.BorderSizePixel = 0
    Frame_23.Position = UDim2.new(0.243, 0, 0.1, 0)
    Frame_23.Size = UDim2.new(0, 3, 0, 313) 
    ...
    Ping.Text = "FPS: N/A                                [Right Ctrl]"
    Ping.TextColor3 = Color3.fromRGB(255,255,255)
    Ping.TextSize = 14.000
    Ping.TextXAlignment = Enum.TextXAlignment.Left
    game:GetService("RunService").RenderStepped:Connect(function(frame)
        Instance.new('LocalScript', Ping).Parent.Text = ("[FPS] : "..math.round(1/frame).."                       Hyper Update!                     [Right Ctrl]") 
    end)
    ...
    UserText.Position = UDim2.new(0.3,7 ,0, -20)
    ...
    UserImage.Position = UDim2.new(0, 10, 0, -20)
    UserImage.Size = UDim2.new(0, 25, 0, 25)
    UserImage.Image = "rbxassetid://14161592006"
    ...
    Logo.Position = UDim2.new(0, 5, 0.033, 20)
    Logo.Size = UDim2.new(0, 125, 0, 115)
    ...
    UserInputService.InputBegan:Connect(function(input)
        if input.KeyCode == Enum.KeyCode.RightControl then
            if uihide == false then
                uihide = true
                Main:TweenSize(UDim2.new(0, 540, 0, 0),"In","Quad",0.4,true)
            else
                uihide = false
